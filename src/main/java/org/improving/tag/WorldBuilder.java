...
import static org.improving.tag.items.UniqueItems.BLUE_SHELL;
...
public class WorldBuilder {
    ...
    public Location buildWorld() {
        ...
        Adversary adversarytmcs = new Adversary("Blue Koopa", 20, BLUE_SHELL);
        ...
        Adversary adversarymd = new Adversary("Sauron", 300, null);
